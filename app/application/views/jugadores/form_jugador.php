								...
								<div class="p-relative">
									<div data-provides="fileinput">
										<div class="fileinput-preview " data-trigger="fileinput">
      									...
      									<span class="pmop-edit btn btn-file waves-effect">
											...
											<dl class="col-md-6">
												<dd>
													<div class="form-group ">
														<div class="fg-line">
															<div class="select">
																<?php echo form_dropdown('id_provincia', $provincias, set_value('id_tipo_provincia',$this->datos_formulario->id_provincia), 'class="form-control"'); ?>
															</div>
														</div>
													</div>
												</dd>
