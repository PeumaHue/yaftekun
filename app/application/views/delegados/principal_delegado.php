<form id="delegado" data-toggle="validator" action="none" method="POST">
	<nav class="navbar navbar-inverse">
		<div class="container-fluid panel-delegados">
			<div class="navbar-collapse titulo_gupo" id="myNavbar">
				<h2 class="input-group"><?php echo lang('html_delegado_titulo_default');?></h2>
	...
	<div class="container ">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row show-grid ">
					<div class="col-xs-12 col-sm-4 pt-8">
						<i class="fa fa-legal ico-panel"></i><?php echo lang('html_delegado_titulo_default');?></div>
						...
						<div class="pull-right">
							<div class="btn-group">
								<button class="btn btn-default btn-xs dropdown-toggle "
									type="button" data-toggle="collapse" data-target="#delegado_body">
									<i id="flecha_delegado" class="fa fa-chevron-down"></i>
								</button>
							</div>
						</div>
					</div>
			...
			<div class="panel-body collapse in" id="delegado_body"
				aria-expanded="true">
