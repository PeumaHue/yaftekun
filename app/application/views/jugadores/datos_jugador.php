            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group  col-sm-6 col-md-3  col-xs-12">
                            <label class="control-label"><?php echo lang('form_label_posicion_juego');?></label>
                        ...
                        <div class="form-group  col-sm-6 col-md-3  col-xs-12">
                            <label class="control-label"><?php echo lang('form_label_numero_camiseta');?></label>
                            <input type="text" id="txt_Camiseta" class="form-control" name="camiseta"   maxlength="2">
                        </div>
                        <div class="form-group  col-sm-6 col-md-3  col-xs-12">
